function createNode(element) {
  ...
  const allPromotion = "https://omm-test.azurewebsites.net/ton/promotion/data/promotion.json";
  
  axios
    .get(allPromotion)
    .then((res) => {
      // console.log(res.data)
      const nodeDiv = document.querySelector("#map-all-promotion")
      ...
      return promotion.map((promotions) => {
        ...
        promotionImageImg.alt = `${promotions.alt}`
